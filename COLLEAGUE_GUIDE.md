...
包括读取/写入飞书物料、发内容小分队复核、汤爱学/郭凤强复核通过后发 PPT 制作群 @胡亮配置二维码、读取群二维码、生成海报、发 226 课程群、团队群 17:00 通知等。  
除了安装仓库，还必须配置飞书机器人 profile。

完整流程顺序如下：

1. 读取直播大纲，提取标题、介绍文案、期数、文章安排。
2. 匹配排期表里的小助手编号。
3. 先在 Codex 窗口输出直播物料预览，等人工确认。
4. 确认后，把物料插入飞书物料文档。
5. 发内容小分队 @汤爱学/郭凤强复核物料。
6. 复核通过后，发 PPT 制作群 @胡亮，请他按直播链接、标题、推广文案、关键词配置二维码。
7. 轮询 PPT 制作群，按发送顺序识别胡亮前 3 张二维码，只下载第 3 张。
8. 生成 4 张直播海报。
9. 在 Codex 窗口展示 4 张海报，等人工确认。
10. 确认后，上传海报到飞书共享空间。
11. 发 PPT 制作群通知胡亮/郭凤强海报已上传。
12. 发 226 课程群：李菁通知、学院预告帖正文、学院海报。
13. 226课程群发送并核验后，紧接着把学院预告帖正文和学院海报同步到群 `oc_e14b3cdc1aac37eeb1cb6dd23fadb70c`，不 @ 任何人。
14. 创建或执行直播当天北京时间 17:00 的螺丝钉团队群小助手安排通知。
15. 更新记录并备份。
...
```text
第 1、2 张二维码 = 只用于确认发送顺序，不生成海报
第 3 张二维码 = qr_3_期数.png = 有二维码
学院海报二维码 = 用直播链接自动生成
```
...
```text
调用 live-poster-codex skill，从生成 4 张海报开始。
期数：465
标题：xxx
直播时间：x月x日（周x）19:00
关键词：260xxx
